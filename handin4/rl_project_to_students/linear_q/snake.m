...
show_fraction  = 1/50;                        % Allowed to be changed. 1: show everything, 0: show nothing, 0.1: show every tenth, and so on...
...
nbr_ep             = 300;                                          % Number of episodes (full games until snake dies) to train
rewards            = struct('default', 0, 'apple', 10, 'death', -10); % Experiment with different reward signals, to see which yield a good behaviour for the agent
...
eps_update_factor  = 0.99;                                           % At eps update: new eps = old eps * eps_update_factor
...
% load weights;alph = 1; eps = 0;show_fraction  =1; show_every_kth = round(1 / show_fraction);  
